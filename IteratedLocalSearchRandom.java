...
/*Estrategia Iterated Local Search Random para colocar os guardas nos vertices dos retangulos */

public class IteratedLocalSearchRandom{
    ...
    public static void createInstance(int n_rectangles, Scanner in) {
        ...
        createIteratedLocalSearchRandom(possibleRectangles,map,n_rectangles,mapRec);
	}
