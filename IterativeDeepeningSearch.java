...
/*Estrategia Iterative Deepening Search para colocar os guardas nos vertices dos retangulos */

public class IterativeDeepeningSearch{

	public static void createIterativeDeepeningSearch(ArrayList<Integer> possibleRectangles,HashMap<Integer, ArrayList<Integer>> map,int n_rectangles, HashMap<Integer, ArrayList<Integer>> mapRec) {
		removeRectangles(n_rectangles, possibleRectangles, map, mapRec);
        IterativeDeepeningSearchSolver iterativeDeepeningSearchSolver = new IterativeDeepeningSearchSolver(possibleRectangles.size(), possibleRectangles, mapRec,map);
        ArrayList<Integer> bestPath = new ArrayList<>();
        int min = Integer.MAX_VALUE;
        for(ArrayList<Integer> path: iterativeDeepeningSearchSolver.allPaths) {
            if(min > path.size()) {
                min = path.size();
                bestPath = path;
            }
    ...
    public static void createInstance(int n_rectangles, Scanner in) {
        ...
        createIterativeDeepeningSearch(possibleRectangles,map,n_rectangles,mapRec);
	}
